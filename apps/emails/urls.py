...
urlpatterns = [
    ...
    path('scenarios/<int:scenario_id>/steps/<int:pk>/test-send/', step_test_send_view, name='step_test_send'),
    ...
    path('campaigns/<int:pk>/test-send/', campaign_test_send_view, name='campaign_test_send'),
]
